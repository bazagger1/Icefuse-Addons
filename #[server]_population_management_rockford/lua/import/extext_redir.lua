...
File Path:   addons/#[server]_population_management_rockford/lua/import/extext_redir.lua
...
function PANEL:AppendImage( image )
        ...
        print((image.mat or image):GetString( "$normalmap" ) )

        local mat = image.mat or image

        local iW, iH
    	iW, iH = image.w or mat:Width(), (image.h or mat:Height()) + self.VPadding
...
vgui.Register( "ExTextRedir", PANEL, "Panel" )
